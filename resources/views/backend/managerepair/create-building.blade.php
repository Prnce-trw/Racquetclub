...
<div class="modal fade in" id="modal-createdbdf" style="display: block;" tabindex="-1">
    <div class="modal-dialog">
        <form class="form-horizontal form-bordered" name="demo-form" id="form-admin" action="{{ url('createbuilding') }}"
              method="post">
            @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-4">
                            <button type="button" id="add" class="btn btn-danger btn-sm">addfloor+</button>
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        $('#add').click(function () {
            ...
            $('#divadd').append('' +
                ...
                '<label class="control-label col-md-2 col-sm-4">floor</label>' +
                '<div class="col-sm-6">' +
